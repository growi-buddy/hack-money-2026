      ...
      >
        ...
        <div className="bg-white rounded-2xl border-2 border-[#e2e8f0] p-8 sm:p-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 bg-[#4ade80]/20 rounded-2xl flex items-center justify-center">
              <Briefcase className="w-7 h-7 text-[#1a2e1a]" />
            </div>
          ...
          <p className="text-[#64748b] text-lg">
            Welcome to your campaign management dashboard. This is a placeholder page - the full dashboard is coming soon.
          </p>
        </div>
      </motion.div>
    </main>
