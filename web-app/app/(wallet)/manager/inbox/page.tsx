...
import { ArrowLeft, Check, CheckCheck, Loader2, MessageSquare, Send } from 'lucide-react';
...
const conversations: Conversation[] = [
  {
    ...
    messages: [
      {
        id: '1',
        text: 'Hi! I saw your campaign invitation for Nike Summer Collection. I\'d love to participate!',
        sender: 'influencer',
        timestamp: '10:30 AM',
      },
      {
        id: '2',
        text: 'Hey Alex! Thanks for your interest. Your profile looks great for this campaign.',
        sender: 'client',
        timestamp: '10:35 AM',
        status: 'read',
      },
      {
        id: '3',
        text: 'Thank you! I have a strong following in the sneaker community. What\'s the expected timeline?',
        sender: 'influencer',
        timestamp: '10:38 AM',
      },
      {
        id: '4',
        text: 'The campaign runs Feb 10-24. You\'ll earn $0.007 per verified view and $0.10 per checkout.',
        sender: 'client',
        timestamp: '10:42 AM',
        status: 'read',
      },
      {
        id: '5',
        text: 'Perfect! I accept the invitation. I\'m excited to start promoting your collection!',
        sender: 'influencer',
        timestamp: '10:45 AM',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: '1',
        text: 'Hello! I applied for the Nike Summer campaign. My audience loves athletic wear!',
        sender: 'influencer',
        timestamp: 'Yesterday',
      },
      {
        id: '2',
        text: 'Hi Sarah! We reviewed your application and would love to have you on board.',
        sender: 'client',
        timestamp: 'Yesterday',
        status: 'read',
      },
      {
        id: '3',
        text: 'That\'s wonderful news! Looking forward to collaborating!',
        sender: 'influencer',
        timestamp: 'Yesterday',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: '1',
        text: 'Thanks for accepting my application to the Adidas campaign!',
        sender: 'influencer',
        timestamp: 'Yesterday',
      },
      {
        id: '2',
        text: 'Welcome aboard Jordan! Your fitness content is perfect for this campaign.',
        sender: 'client',
        timestamp: 'Yesterday',
        status: 'read',
      },
