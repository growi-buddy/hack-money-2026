...
import { Archive, CheckCircle, Clock, DollarSign, MessageSquare, Play, Sparkles, Star, Wallet } from 'lucide-react';
        ...
        <CardContent>
          ...
          >
            {runningCampaigns.map((campaign) => (
              ...
              >
                <Link href={campaign.status === 'active' ? `/web-app/app/(wallet)/influencer/campaign/${campaign.id}/active` : `/web-app/app/(wallet)/influencer/campaign/${campaign.id}`}>
