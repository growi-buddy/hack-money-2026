...
import { EventType, SelectorEventType } from '@/lib/db/prisma/generated';
import { CampaignSummary, RewardEventDTO, SelectorDTO } from '@/types';
...
export default function RewardEventsPage() {
  ...
  useEffect(() => {
    fetchRewardEvents();
    fetchCampaigns();
  }, [ fetchRewardEvents, fetchCampaigns ]);
        ...
        <motion.div variants={scaleIn} initial="hidden" animate="visible">
          <Card className="border-2 border-dashed border-growi-blue/30 bg-growi-blue/5">
            <CardContent className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-xl font-bold text-foreground">No Reward Events Yet</h3>
              <p className="mt-3 max-w-md text-muted-foreground">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full rounded-lg border border-border bg-background px-3 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-growi-blue/50 disabled:opacity-50"
                >
                  <option value="">
                    {loadingCampaigns
                      ? 'Loading campaigns...'
                ...
                {campaigns.length === 0 && !loadingCampaigns && (
                  <p className="mt-2 text-sm text-muted-foreground">
                    You need to create a campaign first.{' '}
                    <button
